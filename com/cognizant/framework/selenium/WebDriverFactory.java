...
public class WebDriverFactory {
	...
	public static WebDriver getWebDriver(Browser browser) {		
		...
		case CHROME:
			...
			System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir")+Util.getFileSeparator()+
					"drivers"+Util.getFileSeparator()+"chromedriver.exe");
			ChromeOptions options = new ChromeOptions();
			Map<String, Object> prefs = new HashMap<String, Object>();
			prefs.put("profile.default_content_setting_values.notifications", 2);
			prefs.put("profile.default_content_settings.popups", 0);
			prefs.put("download.default_directory", System.getProperty("user.dir")+Util.getFileSeparator()+"Downloads");					
			options.setExperimentalOption("prefs", prefs);
			options.addArguments("--disable-notifications");
//			List<String> args = new ArrayList<String>();
//			
//			args.add("runas \\user:rdmst01@na");
//			//args.add("gilead01");
//			Socket s = new Socket();
//			ChromeDriverService service = null;
//			try {
//				service = new ChromeDriverService(new File(System.getProperty("user.dir")+Util.getFileSeparator()+
//						"drivers"+Util.getFileSeparator()+"chromedriver.exe"), s.getLocalPort(), ImmutableList.copyOf(args), null);
//				
//			} catch (IOException e) {
...
//			driver = new ChromeDriver(service, capabilities);
		...
		case EDGE:
			...
			System.setProperty("webdriver.edge.driver",
					System.getProperty("user.dir")+Util.getFileSeparator()+"drivers"+Util.getFileSeparator()+"MicrosoftWebDriver.exe"); // Update Name
