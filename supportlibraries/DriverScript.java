...
public class DriverScript {
	...
	private void initializeReportSettings() {
		...
		reportSettings = new ReportSettings(reportPath,testParameters.getCurrentTestcase() + "_"
				+ testParameters.getCurrentTestInstance().replace("Instance", ""));
	...
	/*	 endTime = Util.getCurrentTime();
	        closeTestReport();
	        createMimeHTML();
	      CurrentTest.addAttachment(new File(reportPath + Util.getFileSeparator()+ "MHTML Results" 
	                + Util.getFileSeparator()+reportSettings.getReportName()+".mht")); 
	        downloadAddtionalReport(); */
	}
